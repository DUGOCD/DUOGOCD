...
function [y_global_best, x_global_best, Convergence_curve]=ESOA(SearchAgents_no, Max_iter, lb, ub, dim, fobj, pop_init,P )
...
w = 2 * rand( SearchAgents_no, dim) - 1;
...
l=l+1;    
Convergence_curve(l+1) = y_global_best;
